...
LEGAL_IMAGE_TYPE =  ('jpg', 'tif', 'bmp', 'png', 'tiff')
...
#         self.fileList = fileList
    ...
    def extractTarFromFileName(fileName, extractTarPath, sizeThreshold = 0, validImageType = ('jpg', 'gif', 'tif', 'bmp', 'png', 'tiff')):
        try:
    #         print sizeThreshold
...
if __name__ == '__main__':   
    ...
    path = "/Users/sephon/Desktop/Research/ReVision/source_papers/Pubmed/ee/"
...
#     ImageFromFile.extractTarFromFileName(f, extractTarPath, 8000)
    ...
    dst = "/Users/sephon/Desktop/Research/ReVision/source_papers/Pubmed/allImages_ee_test/"
    csvFileName = dst + "index.csv"
    ImageFromFile.gatherAllFile(extractTarPath, dst, catList, 4, csvFileName, True)
